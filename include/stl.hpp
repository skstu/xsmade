...
public:
  ...
  static bool ExistsU16(const std::u16string &);
  static bool ExistsW(const std::wstring &);
  static void EnumU8(
...
public:
  ...
  static std::string NormalU8(const std::string &);
  static std::u16string NormalU16(const std::u16string &);
  ...
  static std::string AppendU8(const std::string &abs, const std::string &rel);
