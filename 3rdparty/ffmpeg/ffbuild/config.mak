...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L/c/msys64/clang/lib  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Qunused-arguments
...
EXTRALIBS=-lssl -lcrypto -lz -lbz2 -liconv 
COMPAT_OBJS=
INSTALL=install
